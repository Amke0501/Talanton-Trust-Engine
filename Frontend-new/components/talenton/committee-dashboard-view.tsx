          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-3 border-b border-border">
            ...
            <div className="flex items-center gap-3">
              <div className="rounded-xl bg-[#0d2a1c] px-3 py-1.5 text-white text-xs">
                ...
                <span className="font-bold text-[#a4cc44]">6</span>
              </div>
              <div className="rounded-xl bg-[#0d2a1c] px-3 py-1.5 text-white text-xs">
              ...
              <div className="rounded-xl bg-[#0d2a1c] px-3 py-1.5 text-white text-xs">
                ...
                <span className="font-mono font-bold text-white">UGX 162,600,000</span>
              </div>
            </div>
          </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <span className="flex size-10 items-center justify-center rounded-xl bg-[#103a27] text-white font-bold text-xs">
                      {mem.name.split(' ').map((n) => n[0]).join('').slice(0, 2)}
                    </span>
                    <div>
                      <p className="font-bold text-xs text-foreground">{mem.name}</p>
                      <p className="text-[0.65rem] text-muted-foreground">
                        {mem.memberId} • {mem.classification}
                      </p>
                    </div>
                  </div>
                  <span
                ...
                <div className="grid grid-cols-2 gap-2 rounded-xl bg-muted/30 p-2.5 text-center">
                  <div>
                    ...
                    <span className="text-base font-bold text-emerald-700">{mem.trustScore}</span>
                  ...
                  <div>
                    ...
                    <span className="text-base font-bold text-[#103a27]">{mem.onTimeRatePct}%</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5 text-xs">
                  <div className="flex justify-between text-muted-foreground text-[0.65rem]">
                    ...
                    <span className="font-bold text-foreground">{mem.loansCompleted}</span>
                  </div>
                  <div className="flex justify-between text-muted-foreground text-[0.65rem]">
                    <span>Total repaid:</span>
                    <span className="font-mono font-bold text-foreground">{formatUGX(mem.totalRepaid)}</span>
                  </div>
                  <div className="flex justify-between text-muted-foreground text-[0.65rem]">
                    <span>Current limit:</span>
                    <span className="font-mono font-bold text-emerald-700">{formatUGX(mem.currentLimit)}</span>
                  </div>
                  <div className="flex justify-between text-muted-foreground text-[0.65rem]">
                    <span>Last loan:</span>
                    <span className="font-bold text-foreground">{mem.lastLoanDate}</span>
                  </div>
                </div>
              </div>
            ))}
