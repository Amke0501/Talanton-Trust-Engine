        ...
        <div className="w-full max-w-lg animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="p-10 sm:p-14">
            ...
            <form onSubmit={handleLogin} className="space-y-7">
              ...
              <div className="space-y-2.5">
                <label className="text-xs font-semibold uppercase tracking-wider text-[#2a5040]/70 flex justify-between">
                  Password
                  <Link href="#" className="normal-case tracking-normal hover:underline">Forgot?</Link>
                </label>
                <input
                  type="password"
                  required
            ...
            <p className="text-center text-sm text-[#2a5040]/60 mt-10">
              ...
              <Link href="/signup" className="font-semibold text-[#103a27] hover:underline">
                Sign up
              </Link>
            </p>
          </div>
